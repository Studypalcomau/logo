...
import BoomerangLogo, { BoomerangIcon, BoomerangText, getBoomerangLogoSVG } from '../components/BoomerangLogo';
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-orange-50 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Boomerang.study Logo Assets</h1>
          <p className="text-lg text-gray-600">Knowledge that comes back to you - Developer-ready logo components and assets</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm border">
            <h2 className="text-2xl font-semibold mb-6 text-gray-900">Light Theme</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm text-gray-500">Full Logo - Large</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm text-gray-500">Full Logo - Medium</span>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 border border-gray-700 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm text-gray-400">Full Logo - Large</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-4 border border-gray-700 rounded-lg">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-sm text-gray-400">Full Logo - Medium</span>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border mb-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Design Concept</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-medium mb-3 text-sky-600">The Boomerang Metaphor</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                The boomerang represents the cyclical nature of learning - knowledge and skills that come back to you when you need them most. 
                Just like a boomerang returns to its thrower, the knowledge you gain through study returns to help you succeed.
              </p>
            </div>
            <div>
              <h3 className="font-medium mb-3 text-orange-600">Visual Elements</h3>
              <ul className="text-gray-600 text-sm space-y-1">
                <li>• Curved boomerang shape suggesting movement and return</li>
                <li>• Central study element (book icon) representing knowledge</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg text-sm font-mono">
                <div>import BoomerangLogo, {'{'} BoomerangIcon, BoomerangText {'}'} from './components/BoomerangLogo';</div>
                <div className="mt-2">{'<BoomerangLogo size="lg" theme="light" />'}</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg text-sm font-mono">
                <div>import {'{'} getBoomerangLogoSVG {'}'} from './components/BoomerangLogo';</div>
                <div className="mt-2">const svg = getBoomerangLogoSVG('light', 40);</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Download Section */}
        <div className="bg-white rounded-lg p-8 shadow-sm border">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Download Assets</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button
              onClick={() => downloadSVG(getBoomerangLogoSVG('light', 200), 'boomerang-study-logo-light.svg')}
            ...
            <button
              onClick={() => downloadSVG(getBoomerangLogoSVG('dark', 200), 'boomerang-study-logo-dark.svg')}
              className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-center"
            >
            ...
            <button
              onClick={() => copyToClipboard(`import BoomerangLogo from './components/BoomerangLogo';\n\n<BoomerangLogo size="lg" theme="light" />`)}
              className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-center"
            >
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border mt-8">
          <h2 className="text-2xl font-semibold mb-6 text-gray-900">Technical Specifications</h2>
