...
import StudypalLogo, { StudypalIcon, StudypalText, getStudypalLogoSVG } from '../components/StudypalLogo';
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Studypal Logo Assets</h1>
          <p className="text-lg text-gray-600">Developer-ready logo components and assets</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg text-sm font-mono">
                <div>import StudypalLogo, {'{'} StudypalIcon, StudypalText {'}'} from './components/StudypalLogo';</div>
                <div className="mt-2">{'<StudypalLogo size="lg" theme="light" />'}</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg text-sm font-mono">
                <div>import {'{'} getStudypalLogoSVG {'}'} from './components/StudypalLogo';</div>
                <div className="mt-2">const svg = getStudypalLogoSVG('light', 40);</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-8 shadow-sm border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button
              onClick={() => downloadSVG(getStudypalLogoSVG('light', 200), 'studypal-logo-light.svg')}
            ...
            <button
              onClick={() => downloadSVG(getStudypalLogoSVG('dark', 200), 'studypal-logo-dark.svg')}
              className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-center"
            >
            ...
            <button
              onClick={() => copyToClipboard(`import StudypalLogo from './components/StudypalLogo';\n\n<StudypalLogo size="lg" theme="light" />`)}
              className="p-4 border rounded-lg hover:bg-gray-50 transition-colors text-center"
            >
