...
export const StudypalIcon: React.FC<Omit<StudypalLogoProps, "variant">> = (
  props,
) => <StudypalLogo {...props} variant="icon" />;

export const StudypalText: React.FC<Omit<StudypalLogoProps, "variant">> = (
  props,
) => <StudypalLogo {...props} variant="text" />;

// Utility function to get logo as base64 for emails, documents, etc.
export const getStudypalLogoSVG = (
